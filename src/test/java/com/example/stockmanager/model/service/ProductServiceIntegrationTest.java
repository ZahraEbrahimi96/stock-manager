...
//       productService.save(testProduct);
    ...
    @Test
    void getQuantityById() throws ProductNotFoundException {
    ...
    @Test
    void getAvailableQuantityById() throws ProductNotFoundException {
        Product testProduct = new Product();
        testProduct.setName("book");
        testProduct.setQuantity(12);
        testProduct.setPrice(78);
    ...
    @Test
    void addQuantity() throws ProductNotFoundException {
    ...
    @Test
    void buyProduct_success() throws OutOfStockException, ProductNotFoundException {
        Product testProduct = new Product();
        testProduct.setName("book");
        testProduct.setQuantity(12);
        testProduct.setPrice(78);
